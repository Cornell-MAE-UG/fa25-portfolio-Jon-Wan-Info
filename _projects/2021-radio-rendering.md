...
{% include inline-image.html src="/assets/images/2210Calcs.png" alt="Cycle State Calculations" %}

---

Using the Work and Thermal Transfer found above, we obtain:

**COP (Actual):** 2.18  
**COP (Carnot):** 4.78  
**COP (Carnot to Actual):** 0.46  

{% include inline-image.html src="/assets/images/2210COP.png" alt="COP Calculations" %}
